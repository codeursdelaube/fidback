    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-slate-600">
          Suivez votre formule active, vos méthodes de paiement et téléchargez vos reçus.
        </p>
      </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-indigo-50/70 border border-indigo-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500 text-white font-black flex items-center justify-center text-xs shadow-sm">
                TM
              </div>
              <div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-md shadow-indigo-500/20 transition-all"
            >
