...
/**
 * LEGACY OTP FLOW COMPONENT
 * 
 * Note: Temporairement désactivé pour la phase pilote des startups au Togo.
 * Remplacé par la confirmation email standard (EmailVerifyWaiting).
 * Ce fichier conserve l'intégralité de la logique OTP à 6 chiffres
 * pour pouvoir la réactiver facilement ultérieurement.
 */
...
/* ─── Legacy Verify OTP Component ─────────────────────────────────────────── */
export default function OtpVerifyLegacy({
  email,
  redirectTo = "/app",
  otpType = "email",
  onBack,
